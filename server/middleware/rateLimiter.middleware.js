...
export const strictAuthLimiter = rateLimit({
    ...
    message: {
        message: 'Too many authentication attempts from this IP. Please try again after 6 minutes.',
...
export const moderateAuthLimiter = rateLimit({
    ...
    message: {
        message: 'Too many requests from this IP. Please try again after 6 minutes.',
        retryAfter: 6 * 60
    },
